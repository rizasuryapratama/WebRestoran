    ...
    <div class="container">
        <div class="menu-tabs animate__animated animate__fadeInDown">
           ...
           <a href="{{ route('produk.makanan') }}"><button class="menu-tab">
            ...
            <a href="{{ route('produk.minuman') }}"><button class="menu-tab">
        ...
        <div class="row">
            ...
            <div class="col-md-4 animate__animated animate__fadeIn">
                <div class="menu-card">
                    <div class="menu-image-container">
                        <img src="{{ asset('image/burger.jpeg') }}" alt="Burger" class="menu-image">
                    </div>
            ...
            <div class="col-md-4 animate__animated animate__fadeIn" style="animation-delay: 0.2s;">
                <div class="menu-card">
                    <div class="menu-image-container">
                        <img src="{{ asset('image/nasigoreng.jpeg') }}" alt="Burger" class="menu-image">
                    </div>
                    <div class="menu-content">
                        <div class="menu-title">Nasi Goreng</div>
            ...
            <!-- Menu Item 3 -->
            <div class="col-md-4 animate__animated animate__fadeIn" style="animation-delay: 0.4s;">
                <div class="menu-card">
                    <div class="menu-image-container">
                        <img src="{{ asset('image/ayamgoreng.jpeg') }}" alt="Burger" class="menu-image">
                    </div>
                    <div class="menu-content">
            ...
            <!-- Menu Item 4 -->
            <div class="col-md-4 animate__animated animate__fadeIn" style="animation-delay: 0.6s;">
                <div class="menu-card">
                    <div class="menu-image-container">
                        <img src="{{ asset('image/ayamgeprek.jpeg') }}" alt="Burger" class="menu-image">
                    </div>
                    <div class="menu-content">
